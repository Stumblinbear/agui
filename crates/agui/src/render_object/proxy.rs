...
impl<Child: ?Sized> RenderProxy<Child> {
    pub fn new() -> Self {
        Self {
...
impl<Child: ?Sized> Default for RenderProxy<Child> {
    fn default() -> Self {
        Self::new()
    }
}

impl<Child: RenderBox + ?Sized> SingleChildRenderObject for RenderProxy<Child> {
    type Child = Child;
...
impl<Child: RenderBox + ?Sized> RenderObject for RenderProxy<Child> {
...
impl<Child: RenderBox + ?Sized> RenderBox for RenderProxy<Child> {
