...
use agui::TextureRenderer;
use agui::paint::peniko::Color;
use agui::paint::scene::Scene;
use agui::wgpu;
...
/// [`External`](agui::paint::compositing::CompositedNode::External) surface, which has no
