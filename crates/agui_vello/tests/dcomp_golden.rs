...
use agui_core::geometry::{Rect, Size};
use agui_core::paint::Canvas;
...
use agui_core::paint::peniko::{Color, Fill, kurbo::Affine};
...
///
/// `frame` must not contain an [`External`](agui_core::paint::compositing::CompositedNode::External)
