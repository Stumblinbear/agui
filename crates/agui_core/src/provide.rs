...
//     fn get_as_scope(&self, element_id: ElementId) -> Option<&ProvideScope> {
...
//     fn get_as_scope_mut(&mut self, element_id: ElementId) -> Option<&mut ProvideScope> {
...
//     // pub(crate) fn update_provide_scope(
//     //     &mut self,
...
//     //                 self.update_provide_scope(tree, needs_build, child_scope_id, new_scope_id);
//     //             }
//     //         }
...
//     //                 .copied()
//     //             {
//     //                 self.update_provide_scope(tree, needs_build, child_id, new_scope_id);
//     //             }
//     //         }
//     //     }
//     // }
...
//             || ProvideScope::new(type_id, element_id),
//             |scope| {
//                 scope.add_child_scope(element_id);

//                 ProvideScope::derive_scope(scope, type_id, element_id)
//             },
//         ));
